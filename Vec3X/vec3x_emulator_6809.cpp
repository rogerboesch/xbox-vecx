...
Vec3XEmulator6809::Vec3XEmulator6809(Vec3XEmulator* emulator) {
    vectrex = emulator;
...
unsigned Vec3XEmulator6809::GetRegister(int reg) {
    switch (reg) {
        case VECTREX_REG_X:
            return reg_x;
        case VECTREX_REG_Y:
...
unsigned Vec3XEmulator6809::get_cc (unsigned flag)
{
...
void Vec3XEmulator6809::set_cc (unsigned flag, unsigned value)
{
    reg_cc &= ~flag;
    reg_cc |= value * flag;
}
...
unsigned Vec3XEmulator6809::test_c (unsigned i0, unsigned i1,
...
unsigned Vec3XEmulator6809::test_n (unsigned r)
{
    return (r >> 7) & 1;
}
...
unsigned Vec3XEmulator6809::test_z8 (unsigned r)
{
    unsigned flag;
...
unsigned Vec3XEmulator6809::test_z16 (unsigned r)
{
    unsigned flag;
...
unsigned Vec3XEmulator6809::test_v (unsigned i0, unsigned i1, unsigned r)
{
    unsigned flag;
...
unsigned Vec3XEmulator6809::get_reg_d (void)
{
    return (reg_a << 8) | (reg_b & 0xff);
}

void Vec3XEmulator6809::set_reg_d (unsigned value)
{
    reg_a = value >> 8;
    reg_b = value;
}
...
unsigned Vec3XEmulator6809::read8 (unsigned address)
{
    return vectrex->Read8(address & 0xffff);
}
...
void Vec3XEmulator6809::write8 (unsigned address, unsigned data)
{
    vectrex->Write8(address & 0xffff, (unsigned char) data);
}

unsigned Vec3XEmulator6809::read16 (unsigned address)
{
...
void Vec3XEmulator6809::write16 (unsigned address, unsigned data)
{
    write8 (address, data >> 8);
    write8 (address + 1, data);
}

void Vec3XEmulator6809::push8 (unsigned *sp, unsigned data)
{
    (*sp)--;
    write8 (*sp, data);
}

unsigned Vec3XEmulator6809::pull8 (unsigned *sp)
{
    unsigned data;
...
void Vec3XEmulator6809::push16 (unsigned *sp, unsigned data)
{
    push8 (sp, data);
    push8 (sp, data >> 8);
}

unsigned Vec3XEmulator6809::pull16 (unsigned *sp)
{
    unsigned datahi, datalo;
...
unsigned Vec3XEmulator6809::pc_read8 (void)
{
    unsigned data;
...
unsigned Vec3XEmulator6809::pc_read16 (void)
{
    unsigned data;
...
unsigned Vec3XEmulator6809::sign_extend (unsigned data)
{
...
unsigned Vec3XEmulator6809::ea_direct (void)
{
...
unsigned Vec3XEmulator6809::ea_extended (void)
{
    return pc_read16 ();
}
...
unsigned Vec3XEmulator6809::ea_indexed (unsigned *cycles)
{
    unsigned r, op, ea;
    ...
    case 0x9f:
        ...
        *cycles += 5;
        break;
    default:
        platform_print("undefined post-byte");
        ea = 0;
        break;
    }
...
unsigned Vec3XEmulator6809::inst_neg (unsigned data)
{
    unsigned i0, i1, r;
...
unsigned Vec3XEmulator6809::inst_com (unsigned data)
{
    unsigned r;
...
unsigned Vec3XEmulator6809::inst_lsr (unsigned data)
{
    unsigned r;
...
unsigned Vec3XEmulator6809::inst_ror (unsigned data)
{
    unsigned r, c;
...
unsigned Vec3XEmulator6809::inst_asr (unsigned data)
{
    unsigned r;
...
unsigned Vec3XEmulator6809::inst_asl (unsigned data)
{
    unsigned i0, i1, r;
...
unsigned Vec3XEmulator6809::inst_rol (unsigned data)
{
    unsigned i0, i1, c, r;
...
unsigned Vec3XEmulator6809::inst_dec (unsigned data)
{
    unsigned i0, i1, r;
...
unsigned Vec3XEmulator6809::inst_inc (unsigned data)
{
    unsigned i0, i1, r;
...
void Vec3XEmulator6809::inst_tst8 (unsigned data)
{
...
void Vec3XEmulator6809::inst_tst16 (unsigned data)
{
...
void Vec3XEmulator6809::inst_clr (void)
{
    set_cc (FLAG_N, 0);
    set_cc (FLAG_Z, 1);
    set_cc (FLAG_V, 0);
...
unsigned Vec3XEmulator6809::inst_sub8 (unsigned data0, unsigned data1)
{
    unsigned i0, i1, r;
...
unsigned Vec3XEmulator6809::inst_sbc (unsigned data0, unsigned data1)
{
    unsigned i0, i1, c, r;
...
unsigned Vec3XEmulator6809::inst_and (unsigned data0, unsigned data1)
{
    unsigned r;
...
unsigned Vec3XEmulator6809::inst_eor (unsigned data0, unsigned data1)
{
    unsigned r;
...
unsigned Vec3XEmulator6809::inst_adc (unsigned data0, unsigned data1)
{
    unsigned i0, i1, c, r;
...
unsigned Vec3XEmulator6809::inst_or (unsigned data0, unsigned data1)
{
    unsigned r;
...
unsigned Vec3XEmulator6809::inst_add8 (unsigned data0, unsigned data1)
{
    unsigned i0, i1, r;
...
unsigned Vec3XEmulator6809::inst_add16 (unsigned data0, unsigned data1)
{
    unsigned i0, i1, r;
...
unsigned Vec3XEmulator6809::inst_sub16 (unsigned data0, unsigned data1)
{
    unsigned i0, i1, r;
...
void Vec3XEmulator6809::inst_bra8 (unsigned test, unsigned op, unsigned *cycles)
{
...
void Vec3XEmulator6809::inst_bra16 (unsigned test, unsigned op, unsigned *cycles)
{
    unsigned offset, mask;
...
void Vec3XEmulator6809::inst_psh (unsigned op, unsigned *sp,
...
void Vec3XEmulator6809::inst_pul (unsigned op, unsigned *sp, unsigned *osp,
                       unsigned *cycles)
{
    if (op & 0x01) {
        reg_cc = pull8 (sp);
...
unsigned Vec3XEmulator6809::exgtfr_read (unsigned reg)
{
    unsigned data;
    ...
    default:
        data = 0xffff;
        platform_print("illegal exgtfr reg"); // printf("illegal exgtfr reg %.1x\n", reg
        break;
    }
...
void Vec3XEmulator6809::exgtfr_write (unsigned reg, unsigned data)
{
    switch (reg) {
    case 0x0:
        set_reg_d (data);
...
void Vec3XEmulator6809::inst_exg (void)
{
    unsigned op, tmp;
...
void Vec3XEmulator6809::inst_tfr (void)
{
    unsigned op;
...
unsigned Vec3XEmulator6809::Step(unsigned irq_i, unsigned irq_f)
{
    unsigned op;
    unsigned cycles = 0;
    unsigned ea, i0, i1, r;
    ...
    case 0x10:
        ...
        case 0x3f:
            ...
            break;
        default:
            platform_print("unknown page-1 op code"); // printf ("unknown page-1 op code: %.2x\n", op);
            break;
        }
    ...
    case 0x11:
        ...
        case 0x3f:
            ...
            break;
        default:
            platform_print("unknown page-2 op code"); // printf ("unknown page-2 op code: %.2x\n", op);
            break;
        }
    ...
    default:
        platform_print("unknown page-0 op code"); // printf ("unknown page-0 op code: %.2x\n", op);
        break;
    }
